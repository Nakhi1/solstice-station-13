/obj/machinery/suit_cycler/engineering
	...
	species = list(SPECIES_HUMAN, SPECIES_SKRELL, SPECIES_UNATHI, SPECIES_AKULA, SPECIES_TAJ, SPECIES_VULP, SPECIES_SERGAL) //Add Unathi when sprites exist for their suits.
...
/obj/machinery/suit_cycler/mining
	...
	species = list(SPECIES_HUMAN, SPECIES_SKRELL, SPECIES_UNATHI, SPECIES_AKULA, SPECIES_TAJ, SPECIES_VULP, SPECIES_SERGAL)
